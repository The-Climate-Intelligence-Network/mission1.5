    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box className="relative h-44 overflow-hidden border-b-2 border-ink">
                    <Image
                    ...
                    <Box className="absolute top-3 left-3 px-2 py-1 bg-white border border-ink rounded-none">
                        <Text size="2xs" retro>
                    ...
                    >
                        <Icon
                            as={Bookmark}
                            size="xl"
                            className={isBookmarked ? "text-white fill-white" : "text-black/60"}
                        />
                    </Pressable>
                </Box>
                ...
                <VStack space="sm" className="p-4 items-start">
                    ...
                    <Heading size="md" className="text-ink leading-tight">
                        {mission.title}
                    </Heading>
                    ...
                    <Text
                        size="sm"
                        numberOfLines={2}
                        className="text-ink/70 leading-snug"
                    >
