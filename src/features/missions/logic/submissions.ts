...
import { Tables, Database } from "@/src/core/types/database.types";
import { MissionSubmission, GuidanceStep, EvidenceItem, StepEvidence, SubmissionProgress } from "./types";
